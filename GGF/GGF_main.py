...
def main():
    ...
    filtered = []
    for sigma in sigmas:
        outfile = outdir+'/sig'+str(sigma)
        filtered.append(ggf1(infile,outfile,sigma))
    # TODO: Work on combining
    #combine_ggf(img_dir,filtered, radii_, [[1,1,1,0,0],[0,4,4,4,0],[0,0,8,8,8],[0,0,0,32,32]], infile)
main()
