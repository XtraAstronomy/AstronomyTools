...
def wvt_main(inputs):
    ...
    Final_Bins = WVT(Init_bins,Pixels,inputs['stn_target'],inputs['tol'],pixel_size,inputs['image_dir'])
    print("#----------------Algorithm Complete--------------#")
    plot_Bins(Final_Bins,min_x,max_x,min_y,max_y,inputs['stn_target'],inputs['image_dir'],"final")
